...
public class Menu {
	public static void main(String[] args) {
		...
		ContaCorrente cc1 = new ContaCorrente(contas.gerarNumero(), 123, 1, "Selena Gomez", 50000.0f, 300.0f);
		contas.cadastrar(cc1);
			
		ContaCorrente cc2 = new ContaCorrente(contas.gerarNumero(), 124, 2, "Olivia Rodrigo", 3500.0f, 20);
		contas.cadastrar(cc2);
		
		ContaPoupanca cp1 = new ContaPoupanca(contas.gerarNumero(), 125, 3, "João Vitor", 30000.0f, 12);
		contas.cadastrar(cp1);
		
		ContaPoupanca cp2 = new ContaPoupanca(contas.gerarNumero(), 126, 4, "Carlos Alberto", 70000.0f, 15);
